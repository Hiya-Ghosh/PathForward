<head>
	...
	<body>
		...
		<!--Header-->
        <header id="header" class="transparent-nav" style="position: fixed;background-color:rgb(95,158,160,0.6); top: 0;">
			<div class="container">

				<div class="navbar-header">
					<!-- Logo -->
					<div class="navbar-brand">
						<a class="logo" href="main.php">Path Foster</a>
					</div>
					<!-- /Logo -->
	...
	echo "
	<a href='http://localhost/PathForward/login.php'>Career Prediction</a>
									<a href='http://localhost/PathForward/login.php'>Courses</a>
									<a href='http://localhost/PathForward/login.php'>Knowledge Network</a>
	";
}
				...
				<nav id="nav">
					<ul class="main-menu nav navbar-nav navbar-right">
						<li><a href="main.php">Home</a></li>
                        <li class="dropdown">
                            <a class="dropbtn" href="javascript:void(0)">Services</i></a>
                            <div class="dropdown-content">
