...
<?php include 'header.php'?>
		...
		<div id="home" class="hero-area">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url(./img/hi.jpg); width:100%; height: 656px;"></div>
			<!-- /Backgound Image -->
			...
			<div class="container">
				...
				<div class="row">
					<div class="section-header text-center">
						...
						<h2 style="margin-top: 100px; font-size: 45px;">Welcome to Path Foster</h2>
						...
						<p class="lead"><b style="color: rgb(56, 48, 48);">Path Foster</b> is one stop destination <br>in helping you understand yourself, the best career for you <br> and providing all the resources in the process.</p>
					</div>
				</div>	
		...
		<div id="cta" class="section" style="height: 400px;">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url(./img/hi2.avif)"></div>
			<!-- /Backgound Image -->
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="section-header">
							<h2 style="font-size: 35px;">About Path Foster</h2>
